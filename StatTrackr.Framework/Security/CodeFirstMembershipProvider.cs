    ...
    public class CodeFirstMembershipProvider : CodeFirstExtendedProvider
            {
                ...
                public override string CreateAccount(string userName, string password, string email, bool requireConfirmationToken)
                {
                    ...
                    using (StatContext context = new StatContext())
                    {
                        ...
                        dynamic role = context.Roles.Where(x => x.RoleName == "Administrator").FirstOrDefault();
                        ...
                        if (role != null)
                        {
                            NewUser.Roles = new Collection<Role>();
                ...
                public override System.Web.Security.MembershipUser GetUser(string userName, bool userIsOnline)
                {
                    ...
                    using (StatContext context = new StatContext())
                    {
                        ...
                        return new MembershipUser(Membership.Provider.Name, userName, user.UserID, user.Email, null, null, true, false, user.CreateDate ?? DateTime.Now, DateTime.MinValue,
